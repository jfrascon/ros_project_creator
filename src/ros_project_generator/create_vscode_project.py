...
def main(argv: Optional[Sequence[str]] = None, prog: Optional[str] = None) -> None:
    ...
    try:
        ...
        parser = argparse.ArgumentParser(
            prog=prog,
            description='Create VS Code files around an existing robotics_dockers Compose file',
            allow_abbrev=False,
        ...
        parser.add_argument('user_name', metavar='user-name', help='Development user stored in the image')
        parser.add_argument('ros_distro', metavar='ros-distro', help=f'ROS distro: {supported_ros_distros}')
        parser.add_argument(
            '--compose-file',
            default=None,
            help='Compose file generated by robotics_dockers. Default: <workspace-dir>/docker/docker-compose-dev.yaml',
        )
        parser.add_argument(
            '--no-console-log',
            action='store_true',
        ...
        source_compose_file = (
            ...
            else workspace_dir.joinpath('docker/docker-compose-dev.yaml')
        )
